...
export function getMultipleHints(req: Request, res: Response) {
    const ids = req.body;
    console.log(ids);
    let counter = 0;
...
// finds hint multiple hints by field and value
// /hints/{field}&{value}
// example:
